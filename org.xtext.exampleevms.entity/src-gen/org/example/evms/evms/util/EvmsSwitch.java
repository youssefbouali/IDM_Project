  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case EvmsPackage.EVENEMENT:
      {
        ...
        if (result == null) result = caseRootElement(evenement);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EvmsPackage.LIEU:
      {
        ...
        if (result == null) result = caseRootElement(lieu);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EvmsPackage.UTILISATEUR:
      {
        ...
        if (result == null) result = caseRootElement(utilisateur);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EvmsPackage.INSCRIPTION:
      {
        ...
        if (result == null) result = caseRootElement(inscription);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EvmsPackage.NOTIFICATION:
      {
        ...
        if (result == null) result = caseRootElement(notification);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
